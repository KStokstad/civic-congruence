...
PATTERN_LABEL: Write a plain civic identity pattern in 8 words or fewer. Must be understandable to a cold viewer in 3 seconds. It should sound like something a person would say, not a score summary or database output. Avoid: score comparisons, area names, percentages, technical civic terms. Use: plain conversational English, first-person adjacent phrasing. Do not compare scores to each other directly. Translate the score pattern into a human civic identity — something the person would recognize in themselves. Format: "[Feels/Sees] [X], but [Y]." Lookup guide: Economy high + Education/Governance low → "Sees opportunity, but not accountability." Health high + Economy low → "Holding health together while costs strain." Safety low + Governance low → "Feels exposed and unheard." Education low + Economy low → "Worried the basics are slipping." Governance low + mixed → "Wants answers, not vague promises." All low → "Sees the gaps. Not asking for much."
