      ...
      <section className="hero">
        <div className="container">
          ...
          <p className="hero-sub">
            We capture what people are actually experiencing —{' '}
            <span style={{ whiteSpace: 'nowrap' }}>what's working, what isn't</span>{' '}
            — and make it visible to the people making decisions.
          </p>
