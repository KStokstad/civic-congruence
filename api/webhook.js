...
const QUESTIONS = [
  ...
  { fieldName: 'Q9',  topic: 'Compromise',             options: { A: 'Compromise signals weak conviction. Real leadership means holding the line.', B: 'Compromise on tactics is necessary, but compromise on core values is capitulation. The difference matters.', C: 'Compromise is the basic requirement of democratic governance. Without it, nothing functions.', D1: "Whether to compromise depends entirely on what's being traded. Values versus tactics are different things.", D2: 'The system is too broken for compromise to matter. The premise no longer applies.' } },
